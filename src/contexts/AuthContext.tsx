...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const isAdmin = user?.email === 'admin@oecl.sg' || user?.email === 'admin@amassmiddleeast.com' || localStorage.getItem("isAdminLoggedIn") === "true";
  ...
  const fetchProfile = async (userId: string) => {
    try {
      ...
      const userIsAdmin = user?.email === 'admin@oecl.sg' || user?.email === 'admin@amassmiddleeast.com' || localStorage.getItem("isAdminLoggedIn") === "true";
